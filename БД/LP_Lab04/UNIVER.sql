...
------Создание и заполнение таблицы TIMETABLE
...
(
	...
	DAYWEEK date,
	PAIR int constraint PAIR_const check(PAIR between 1 and 4)
);

insert into TIMETABLE(IDGROUP, AUDITORIUM, SUBJECT, TEACHER, DAYWEEK, PAIR)
	values(4, '236-1', 'БД', 'БРГ', '2023-03-12', 1),
		  (6, '413-1', 'МП', 'МРЗ', '2023-03-12', 4),
		  (10, '423-1', 'БД', 'БРГ', '2023-03-12', 3),
		  (9, '236-1', 'ООП', 'РЖК', '2023-03-12', 2),
		  (5, '206-1', 'ЛВ', 'УРБ', '2023-03-12', 1)
